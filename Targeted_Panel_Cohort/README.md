...
Builds on previous work from Dr. Gerben Duns (BCCancer), using his Snakemake pipeline for alignment and quality control of targeted sequencing data. The CNA calling also leverages his CNVkit pipeline. 
